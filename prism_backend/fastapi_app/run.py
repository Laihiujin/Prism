...
if __name__ == "__main__":
    ...
    result = ensure_playwright_chromium_installed(auto_install=auto_install)
    print(f"[PLAYWRIGHT] PLAYWRIGHT_BROWSERS_PATH={result.browsers_path}")
    if not result.installed:
        print(f"[PLAYWRIGHT] Chromium not ready: {result.error}")
